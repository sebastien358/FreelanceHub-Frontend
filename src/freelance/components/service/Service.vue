...
<template>
  <section class="services">
    <div class="container">
      <h1>Mes Services</h1>
      <p class="intro">
        Des prestations modernes, performantes et adaptées à vos besoins — du site vitrine à l’application complète.
      </p>
      ...
      <div class="daily-rate">
        ...
        <p>
          Entre <strong>350 €</strong> et <strong>500 €</strong> / jour selon la complexité du projet et le niveau d’intégration souhaité.
        </p>
        <p class="note">
          🧾 Tous les projets incluent un suivi complet, des sauvegardes et une documentation claire.
        </p>
      </div>
