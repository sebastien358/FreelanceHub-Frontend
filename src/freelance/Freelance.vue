  ...
  <section id="accueil" class="hero section">
    <div class="container hero-inner">
      ...
      <div class="hero-right">
        ...
        <img src="/src/assets/images/code.jpg" alt="laptop" class="hero-mock" />-->
      </div>
    </div>
  </section>
...
const projects = [
  { title: 'E-commerce', sub: 'Frontend & API', image: '/src/assets/images/'},
  { title: 'Application de gestion', sub: 'Vue + Symfony', image: '/src/assets/project-crm.jpg' }
]
...
onMounted(() => {
  ...
  gsap.from(projectsTitle.value, {
    ...
    y: 40,
    duration: 0.8,
    scrollTrigger: { trigger: projectsTitle.value, start: 'top 75%' }
  })
...
.skills-grid {
  ...
  .skill-card {
    ...
    &:hover {
      ...
      box-shadow: 0 20px 40px rgba(0,0,0,0.6), 0 0 30px rgba($neon, 0.06);
    }
    .skill-icon img { width: 56px; height:56px; object-fit:contain; filter: drop-shadow(0 6px 18px rgba(0,0,0,0.5)); }
    .skill-name { margin-top: 12px; color: #dcefff; font-weight:600 }
  }
}
...
.project-card {
  ...
  .project-media {
    height: 170px;
    overflow: hidden;
    img { width:100%; height:100%; object-fit:cover; transform-origin:center; transition: transform .4s ease; }
  }
  .project-footer {
    padding: 18px;
    h3 { margin: 0 0 6px; color: #e9f5ff; }
    .project-sub { color: $muted; font-size: .95rem; margin:0;}
  }
